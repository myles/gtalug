...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('meetings', 'location', self.gf('django.db.models.fields.TextField')(default='<p>Room GB248, Galbraith Building, University of Toronto\n35 St George St<br>\nToronto, Ontario M5S 3G8<br>\nUniversity of Toronto</p>', max_length=500), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Meeting.location'
        db.delete_column('meetings', 'location')
    ...
    models = {
        ...
        'meetings.meeting': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.TextField', [], {'max_length': '500'}),
