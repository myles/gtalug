...
from gtalug.apps.blog.models import *
...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_posts', (
            ...
            ('published', orm['blog.Post:published']),
            ('tease', orm['blog.Post:tease']),
            ('body', orm['blog.Post:body']),
            ('date_added', orm['blog.Post:date_added']),
            ('date_modified', orm['blog.Post:date_modified']),
        ))
